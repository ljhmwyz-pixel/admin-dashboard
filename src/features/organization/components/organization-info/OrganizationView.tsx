...
import type { TreeNodeData } from '@/features/organization/dto';
import { type OrganizationFormData, useOrganizationForm } from '@/features/organization/hooks';
import { getParentNode } from '@/features/organization/utils';
import organizationApi from '@/services/modules/organization/organizationApi';
import { AntForm, AntRow, AntSpin } from '@/shared/components';
...
const OrganizationView: React.FC<OrganizationViewIProps> = ({
  ...
  return (
    <AntSpin description="加载中..." spinning={spinning}>
